...
[![Website Badge](https://img.shields.io/badge/Website-fff?logo=appveyor&logoColor=000&style=for-the-badge)](https://atlasink.app)
[![Email Badge](https://img.shields.io/badge/Email-D14836?logo=gmail&logoColor=fff&style=for-the-badge)](mailto:hello@atlasink.app)
[![LinkedIn Badge](https://img.shields.io/badge/LinkedIn-0A66C2?logo=linkedin&logoColor=fff&style=for-the-badge)](https://www.linkedin.com/company/atlasink/)
[![Instagram](https://img.shields.io/badge/Instagram-E4405F?logo=instagram&logoColor=fff&style=for-the-badge)](https://instagram.com/atlasink.app)
[![YouTube](https://img.shields.io/badge/YouTube-FF0000?logo=youtube&logoColor=fff&style=for-the-badge)](https://www.youtube.com/@atlasinkapp)
[![Threads](https://img.shields.io/badge/Threads-000?logo=threads&logoColor=fff&style=for-the-badge)](https://www.threads.net/@atlasink.app)
[![Reddit](https://img.shields.io/badge/Reddit-FF4500?logo=reddit&logoColor=fff&style=for-the-badge)](https://www.reddit.com/r/atlasink)
[![TikTok](https://img.shields.io/badge/TikTok-000?logo=tiktok&logoColor=fff&style=for-the-badge)](https://www.tiktok.com/@atlasink.app)
[![Product Hunt](https://img.shields.io/badge/Product%20Hunt-DA552F?logo=producthunt&logoColor=fff&style=for-the-badge)](https://www.producthunt.com/products/atlasink)
...
[![GitHub Badge](https://img.shields.io/badge/GitHub-fff?logo=github&logoColor=000&style=for-the-badge)](https://github.com/BuildByNazat/atlasink)
...
This project is a JavaScript reimplementation inspired by the original MapToPoster [originalankur/maptoposter](https://github.com/originalankur/maptoposter) by [Ankur Gupta](https://github.com/originalankur) (MIT license). My app is built using Bun, React, and TypeScript. It allows users to create custom city map posters with various styling options, leveraging OpenStreetMap data rendered via MapLibre and OpenFreeMap vector tiles. Built by [BuildByNazat](https://github.com/BuildByNazat).
...
<!-- TODO: Replace screenshots/assets with AtlasInk branded versions -->
...
```bash
docker build -t atlasink:latest .
docker run -d --name atlasink -p 7200:80 --restart unless-stopped atlasink:latest
```

## Contributing

> The contribution guidelines are meant to keep AtlasInk easy to extend, review, and maintain over time. They are here to support a durable architecture, not to add unnecessary friction.
...
[![Star History Chart](https://api.star-history.com/svg?repos=BuildByNazat/atlasink&type=Date)](https://star-history.com/#BuildByNazat/atlasink&Date)
...
The **AtlasInk** name, logo, and branding assets are marks associated with this project.</br>
